...
{
    override fun repr() : String = RT.structRepr("ellipse", Triple(false, null, body), Triple(false, "width", width), Triple(false, "height", height), Triple(false, "fill", fill), Triple(false, "stroke", stroke), Triple(false, "inset", inset), Triple(false, "outset", outset), )
}
