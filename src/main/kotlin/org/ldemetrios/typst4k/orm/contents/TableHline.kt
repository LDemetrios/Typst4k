...
{
    override fun repr() : String = RT.structRepr("table.hline", ArgumentEntry(false, "y", y), ArgumentEntry(false, "start", start), ArgumentEntry(false, "end", end), ArgumentEntry(false, "stroke", stroke), ArgumentEntry(false, "position", position), )
}
