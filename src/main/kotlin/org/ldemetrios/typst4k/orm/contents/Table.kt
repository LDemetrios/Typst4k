...
{
    override fun repr() : String = RT.structRepr("table", ArgumentEntry(true, null, children), ArgumentEntry(false, "columns", columns), ArgumentEntry(false, "rows", rows), ArgumentEntry(false, "gutter", gutter), ArgumentEntry(false, "column-gutter", columnGutter), ArgumentEntry(false, "row-gutter", rowGutter), ArgumentEntry(false, "fill", fill), ArgumentEntry(false, "align", align), ArgumentEntry(false, "stroke", stroke), ArgumentEntry(false, "inset", inset), )
}
