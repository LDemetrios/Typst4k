...
{
    override fun convert() = TEllipse(width?.convert().cast(), height?.convert().cast(), fill?.convert().cast(), stroke?.convert().cast(), inset?.convert().cast(), outset?.convert().cast(), body?.convert().cast())
}
